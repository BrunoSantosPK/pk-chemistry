        ...
        <div class="container mt-5">
            <div class="row">
                <div class="col-12">
                    ...
                    <ul>
                        <li class="link" onclick="alterar('tabelaPeriodica')">Elementos Químicos (Tabela Periódica) - Em breve</li>
        ...
        <div class="container mt-5 conteudo" id="mm">
            <div class="row">
                <div class="col-12">
                    ...
                    <h5>Exemplo: NaCl, KCl, Fe2(SO4)3, CuSO4(H2O)5 e etc.</h5>
                    <form class="formulario" action="javascript:calcMM()">
                        <label>Informe a fórmula química</label>
