<?php
    ...
    class ElementoQuimico {
        ...
        public static $elementos = array(
            ...
            array("simbolo" => "Ta", "nome" => "Tálio", "mm" => 204.38),
            array("simbolo" => "Pb", "nome" => "Chumbo", "mm" => 207.2),
            array("simbolo" => "Bi", "nome" => "Bismuto", "mm" => 208.98),
            array("simbolo" => "Po", "nome" => "Polônio", "mm" => 209),
            array("simbolo" => "At", "nome" => "Astato", "mm" => 210),
            array("simbolo" => "Rn", "nome" => "Radônio", "mm" => 222),
            array("simbolo" => "Fr", "nome" => "Frâncio", "mm" => 223),
            array("simbolo" => "Ra", "nome" => "Rádio", "mm" => 226),
            array("simbolo" => "Ac", "nome" => "Actínio", "mm" => 227),
            array("simbolo" => "Th", "nome" => "Tório", "mm" => 232.04),
            array("simbolo" => "Pa", "nome" => "Protactínio", "mm" => 231.04),
            array("simbolo" => "U", "nome" => "Urânio", "mm" => 238.06),
            array("simbolo" => "Np", "nome" => "Neptúnio", "mm" => 237),
            array("simbolo" => "Pu", "nome" => "Plutônio", "mm" => 244),
            array("simbolo" => "Am", "nome" => "Amerício", "mm" => 243),
            array("simbolo" => "Cm", "nome" => "Cúrio", "mm" => 247),
            array("simbolo" => "Bk", "nome" => "Berquélio", "mm" => 247),
            array("simbolo" => "Cf", "nome" => "Califórnio", "mm" => 251),
            array("simbolo" => "Es", "nome" => "Einstênio", "mm" => 252),
            array("simbolo" => "Fm", "nome" => "Férmio", "mm" => 257),
            array("simbolo" => "Md", "nome" => "Mendelévio", "mm" => 258),
            array("simbolo" => "No", "nome" => "Nobélio", "mm" => 259),
            array("simbolo" => "Lr", "nome" => "Laurêncio", "mm" => 266),
            array("simbolo" => "Rf", "nome" => "Rutherfórdio", "mm" => 267),
            array("simbolo" => "Db", "nome" => "Dúbnio", "mm" => 268),
            array("simbolo" => "Sg", "nome" => "Seabórgio", "mm" => 269),
            array("simbolo" => "Bh", "nome" => "Bóhrio", "mm" => 270),
            array("simbolo" => "Hs", "nome" => "Hássio", "mm" => 277),
            array("simbolo" => "Mt", "nome" => "Meitnério", "mm" => 278),
            array("simbolo" => "Ds", "nome" => "Damstácio", "mm" => 281),
            array("simbolo" => "Rg", "nome" => "Roentgênio", "mm" => 282),
            array("simbolo" => "Cn", "nome" => "Copemício", "mm" => 285),
            array("simbolo" => "Nh", "nome" => "Nihonium", "mm" => 286),
            array("simbolo" => "Fl", "nome" => "Fleróvio", "mm" => 289),
            array("simbolo" => "Mc", "nome" => "Moscovium", "mm" => 290),
            array("simbolo" => "Lv", "nome" => "Livemório", "mm" => 293),
            array("simbolo" => "Ts", "nome" => "Tennessine", "mm" => 294),
            array("simbolo" => "Og", "nome" => "Oganesson", "mm" => 294)
        );
